...
export default function Farm() {
  ...
  return (
    <div className="min-h-screen text-white space-y-4 relative">
          ...
          <table className="w-full">
            <thead className="bg-blue-900">
              <tr className="border-b-2 border-yellow-400">
                <th className="px-4 py-3 text-left text-yellow-400 text-sm font-dela uppercase">
                  ALL POOLS
                </th>
                <th className="px-4 py-3 text-center text-yellow-400 text-sm font-dela uppercase">
                  APR
                </th>
                <th className="px-4 py-3 text-center text-yellow-400 text-sm font-dela uppercase">
                  TVL
                ...
                >
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div
                          className="font-dela text-lg cursor-pointer hover:text-yellow-400 transition-colors"
